...
<title>添加角色信息</title>
	...
	function doEditRole(){
		...
		$.ajax({
			...
			data:{
				...
				"role.type":theType,
				"role.createTime":$("#createTime").val(),
    ...
    function setChecked(){
    	$.ajax({
			...
			success:function(jsonObject){
				if(jsonObject.success){
					$.each(jsonObject.idList,function(i,n){
...
<body>
                ...
                <div style = "width:86%">
                <input id="createTime" type="hidden" value="${role.createTime}">
				  <div class="form-group">
				    <label class="col-sm-2 control-label" for="roleid">角色编号</label>
					    <div class="col-sm-10">
						    <input id="roleid" type="text" class="form-control" readonly="readonly" value="${role.id}" placeholder="请输入角色编号">
					    </div>
				  </div>
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-sm-10">
						    <input id="rolename" type="text" class="form-control" value="${role.name}" placeholder="请输入角色名称">
					    </div>
				    </div>
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-sm-6">
						    ...
						    <c:if test="${role.type=='1'}">
							    	<label class="checkbox-inline">
										<input type="radio" name="roleRadio" value="0" >普通用户
									</label>
									<label class="checkbox-inline">
										<input type="radio" name="roleRadio" value="1" checked="checked">管理员
									</label>
							</c:if>
						 </div>
				    </div>
				   ...
				   <div class="form-group">
					    ...
					    <div class="col-sm-10">
						    <input type="text" class="form-control" placeholder="" value="${role.remark}" id="roleremark">
					    </div>
				    </div>
				    
				   </div>
				     <center>
					     <button type="submit" class="btn btn-default" onclick="doAll()">提交</button>
