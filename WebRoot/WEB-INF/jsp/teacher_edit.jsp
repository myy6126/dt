...
<body>
                ...
                <input id="teacherid" value="${teacherInfo.id}" type="hidden">
                <div style = "width:86%">
				  <div class="form-group">
				    <label class="col-sm-2 control-label" for="teacherName">教师姓名</label>
					    <div class="col-sm-10">
						    <input id="teacherName" type="text" class="form-control" value="${teacherInfo.name}" placeholder="请输入教师姓名">
					    </div>
				  </div>
				   ...
				   <div class="form-group">
					   ...
					   <div class="col-sm-6">
	                		<div class="input-group date form_date" data-date="" data-date-format="yyyy-mm" data-link-format="yyyy-mm" data-link-field="teacherBirth">
		                    	<input id="teacherBirth" class="form-control" size="16" type="text" value="${teacherInfo.birth}" readonly>
				     ...
				     <div class="form-group">
						    ...
						    <div class="col-sm-10">
							     <select class="form-control" id="department">
					                  <c:forEach var="crc"   items="${crcList}">
					                  		<c:if test="${teacherInfo.department==crc.subject}">
					  ...
					  <div class="form-group">
					    <label class="col-sm-2 control-label" for="remark">备注</label>
						    <div class="col-sm-10">
							    <input id="remark" type="text" class="form-control" value="${teacherInfo.remark}" placeholder="">
						    </div>
					  </div>
